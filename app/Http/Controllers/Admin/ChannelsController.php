...
class ChannelsController extends Controller
{
    ...
    public function create()
    {
        ...
        $sensors = Sensor::all()->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.channels.create', compact('sensors'));
    }
    ...
    public function edit(Channel $channel)
    {
        ...
        return view('admin.channels.edit', compact('sensors', 'channel'));
    }
